...
import { FaReact, FaNodeJs, FaGithub, FaAws,FaServer } from "react-icons/fa";
import {
  SiExpress,
  SiMongodb,
  SiNestjs,
...
const skills = [
  ...
  {
    name: "Nest.js",
    icon: <SiNestjs className="w-5 h-5 sm:w-6 sm:h-6" />,
    size: "col-span-1 row-span-1",
  },
  {
    name: "Java Script",
    icon: <IoLogoJavascript className="w-5 h-5 sm:w-6 sm:h-6" />,
    size: "col-span-1 row-span-1",
  },
  {
    name: "Type Script",
  ...
  {
    name: "Postman ",
    icon: <SiPostman className="w-5 h-5 sm:w-6 sm:h-6" />,
    size: "col-span-1 row-span-1",
  },
  {
    name: "Lambda ",
    icon: <SiAwslambda className="w-5 h-5 sm:w-6 sm:h-6" />,
    size: "col-span-1 row-span-1",
  },
];
