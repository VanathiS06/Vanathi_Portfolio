...
const Logo = ({ isMobile = false }) => (
  ...
  >
    ...
    >
      ...
      >
        <span className="hidden sm:inline">{config.developer.name} | Dev</span>
...
const ContactButton = ({ isMobile = false, onLinkClick }) => (
  ...
  >
    ...
    <a
      href="/Vanathi_Resume.pdf"
      download="Vanathi_Resume.pdf" // custom filename when downloaded
      className={isMobile ? "w-full" : ""}
    >
      <Button
        className={`${
    ...
    {/* Preview CV link (opens in browser tab) */}
    {/* <Link
      href="/Vanathi_Resume.pdf"
      target="_blank"
